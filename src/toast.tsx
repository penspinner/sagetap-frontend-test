...
export const Toast = ({ description, type, ...props }: ToastProps) => {
  return (
    <RadixToast
      className="[&[data-state='closed']]:animate-toast-out [&[data-state='open']]:animate-toast-in [&[data-swipe='move']]:translate-x-[var(--radix-toast-swipe-move-x)] [&[data-swipe='end']]:animate-toast-swipe-out"
      {...props}
    >
      <div className="pointer-events-auto w-full max-w-sm overflow-hidden rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5">
        <div className="flex items-start gap-x-3 p-4">
          ...
          <div className="w-0 flex-1 pt-0.5">
            <ToastDescription className="overflow-auto text-sm font-medium text-gray-900">
              {description}
            </ToastDescription>
          </div>
